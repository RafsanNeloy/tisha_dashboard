...
import { updateBillWastage } from '../../action/billsAction';
...
const WestageForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await dispatch(updateBillWastage(selectedBill, Number(formData.amount)));
            
            setAlert({
                open: true,
                message: 'Wastage amount updated successfully',
                severity: 'success'
            });
            ...
            setAlert({
                open: true,
                message: error.response?.data?.message || 'Error updating wastage amount',
                severity: 'error'
            });
        } finally {
            setLoading(false);
